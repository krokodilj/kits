...
insert into kts_test.permission (id, name) values (14, 'GET_BUILDINGS');
...
insert into kts_test.role_permissions (role_id, permissions_id) values (2, 14);
...
insert into kts_test.role_permissions (role_id, permissions_id) values (4, 10);
